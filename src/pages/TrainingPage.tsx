...
const text: Record<Lang, TrainingText> = {
  ru: {
    ...
    endgames: 'Эндшпиль',
    endgamesText: 'Разбирай окончания и ошибки из своих партий.',
    startPuzzles: '\u041d\u0430\u0447\u0430\u0442\u044c \u0437\u0430\u0434\u0430\u0447\u0438',
    studyOpenings: '\u0418\u0437\u0443\u0447\u0430\u0442\u044c \u0434\u0435\u0431\u044e\u0442\u044b',
    studyEndgames: 'Тренировать эндшпиль',
  },
  en: {
    title: 'Training',
    ...
    endgames: 'Endgames',
    endgamesText: 'Review endgame mistakes and endings from your own games.',
    startPuzzles: 'Start puzzles',
    studyOpenings: 'Study openings',
    studyEndgames: 'Train endgames',
  },
  kk: {
    title: '\u0416\u0430\u0442\u0442\u044b\u0493\u0443',
  ...
  return (
    <div className="page-grid">
      ...
      <section className="training-grid">
        ...
        <TrainingCard title={labels.endgames} text={labels.endgamesText} action={labels.studyEndgames} href="/endgames" />
      </section>
      {loading
